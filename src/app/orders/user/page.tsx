  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        toast.success("Your orders have been loaded successfully");
      } catch (err) {
        const message =
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          <Link href="/orders">
            <Button className="bg-white text-slate-900 border hover:bg-slate-50 cursor-pointer">All Orders</Button>
          </Link>
                    ...
                    <div className="text-sm text-gray-600 space-y-2">
                      {order.shippingAddress ? (
                        <>
                          ...
                          <p>
                            <span className="font-semibold">Details:</span> {order.shippingAddress.details}
                          </p>
                        </>
                      ) : (
